...
#define _nstates10	14	/* p51 */
#define minseq10	128
#define maxseq10	140
#define _endstate10	13

#define _nstates9	14	/* p5 */
#define minseq9	115
#define maxseq9	127
#define _endstate9	13

#define _nstates8	14	/* p41 */
#define minseq8	102
#define maxseq8	114
#define _endstate8	13

#define _nstates7	14	/* p4 */
#define minseq7	89
#define maxseq7	101
#define _endstate7	13

#define _nstates6	9	/* p3 */
#define minseq6	81
#define maxseq6	88
#define _endstate6	8

#define _nstates5	11	/* p2 */
#define minseq5	71
#define maxseq5	80
#define _endstate5	10

#define _nstates4	11	/* p1 */
#define minseq4	61
#define maxseq4	70
#define _endstate4	10

#define _nstates3	23	/* controller */
#define minseq3	39
#define maxseq3	60
#define _endstate3	22

#define _nstates2	14	/* floor3 */
#define minseq2	26
#define maxseq2	38
#define _endstate2	13

#define _nstates1	14	/* floor2 */
#define minseq1	13
#define maxseq1	25
#define _endstate1	13

#define _nstates0	14	/* floor1 */
#define minseq0	0
#define maxseq0	12
...
#define Air3	(sizeof(P3) - Offsetof(P3, piano) - 1*sizeof(short))

#define Pfloor3	((P2 *)_this)
typedef struct P2 { /* floor3 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Pfloor2	((P1 *)_this)
typedef struct P1 { /* floor2 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
...
#define Pfloor1	((P0 *)_this)
typedef struct P0 { /* floor1 */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
