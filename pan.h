...
#define _nstates9	14	/* p6 */
#define minseq9	124
#define maxseq9	136
#define _endstate9	13

#define _nstates8	14	/* p51 */
#define minseq8	111
#define maxseq8	123
#define _endstate8	13

#define _nstates7	14	/* p5 */
#define minseq7	98
#define maxseq7	110
#define _endstate7	13

#define _nstates6	14	/* p41 */
#define minseq6	85
#define maxseq6	97
#define _endstate6	13

#define _nstates5	14	/* p4 */
#define minseq5	72
#define maxseq5	84
#define _endstate5	13

#define _nstates4	9	/* p3 */
#define minseq4	64
#define maxseq4	71
#define _endstate4	8
...
#define _nstates1	24	/* controller */
#define minseq1	21
#define maxseq1	43
#define _endstate1	23

#define _nstates0	22	/* floorButtons */
#define minseq0	0
#define maxseq0	20
...
#define PfloorButtons	((P0 *)_this)
typedef struct P0 { /* floorButtons */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 5; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
