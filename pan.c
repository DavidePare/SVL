...
short src_ln3 [] = {
	  0,  55,  59,  61,  63,  64,  65,  59, 
	 67,  69,  67,  70,  72,  70,  58,  74, 
	 57,  76,  57,  54,  77,  54,  77,   0, };
S_F_MAP src_file3 [] = {
	{ "-", 0, 0 },
	{ "file.pml", 1, 22 },
	{ "-", 23, 24 }
...
{	int j = 0, h = now._nr_pr;
	...
	case 12:	/* claim select */
		spin_c_typ[0] = 10; /* p51 */
		((P12 *)pptr(h))->c_cur[0] = 5;
		reached10[5]=1;
		spin_c_typ[1] = 9; /* p5 */
		((P12 *)pptr(h))->c_cur[1] = 5;
		reached9[5]=1;
		spin_c_typ[2] = 8; /* p41 */
	...
	case 3:	/* controller */
		...
		((P3 *)pptr(h))->piano = 0;
#ifdef VAR_RANGES
		logval("controller:piano", ((P3 *)pptr(h))->piano);
#endif
#ifdef HAS_CODE
		locinit3(h);
#endif
